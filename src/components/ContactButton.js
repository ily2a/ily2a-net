...
export default function ContactButton({ label = 'Contact', onClick }) {
  ...
  return (
    ...
    >
      ...
      <div className={`${layerClass} transition-opacity duration-300 ${hovered ? 'opacity-100' : 'opacity-0'}`} style={{ background: conicGradient }} />
      <div className={`${layerClass} blur transition-opacity duration-300 ${hovered ? 'opacity-100' : 'opacity-0'}`} style={{ background: conicGradient }} />
      <div className={`${layerClass} rotate-180 transition-opacity duration-300 ${hovered ? 'opacity-100' : 'opacity-0'}`} style={{ background: conicGradient }} />
      <div className={`${layerClass} blur rotate-180 transition-opacity duration-300 ${hovered ? 'opacity-100' : 'opacity-0'}`} style={{ background: conicGradient }} />
