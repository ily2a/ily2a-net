...
const FOCUS_RING_ERROR   = { boxShadow: '0 0 0 2px #e57373' }
  ...
  return (
    <section id="contact" className="contact-section">
      <div className="contact-inner">
        ...
        >
            ...
            <div className="flex flex-col gap-3 md:flex-row">
              ...
              <div className="flex flex-col gap-2 flex-1">
                <label htmlFor="name" className="text-[14px] font-medium" style={{ color: 'var(--color-text-primary)' }}>
                  Full name
                </label>
                <motion.input
                  ...
                  style={{
                    background: 'color-mix(in srgb, var(--color-surface) 60%, #0d1114)',
                    border: 'none',
              ...
              {/* Email */}
              <div className="flex flex-col gap-2 flex-1">
                <label htmlFor="email" className="text-[14px] font-medium" style={{ color: errors.email ? '#e57373' : 'var(--color-text-primary)' }}>
                  Email
                </label>
                <motion.input
                ...
                />
                {errors.email && (
                  <p className="text-[12px]" style={{ color: '#e57373' }}>Please enter a valid email.</p>
                )}
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <motion.textarea
                ...
                onChange={handleChange}
                required rows={6}
                className="w-full rounded-[10px] px-4 py-3 outline-none resize-y"
                style={{
                  background: 'color-mix(in srgb, var(--color-surface) 60%, #0d1114)',
                  border: 'none',
                  color: 'var(--color-text-primary)',
              ...
              />
              {errors.message && (
                <p className="text-[12px]" style={{ color: '#e57373' }}>Please tell me how I can help.</p>
              )}
            </div>
            ...
            <div aria-live="polite" aria-atomic="true">
              {status === 'error' && (
                <div className="flex items-center gap-3">
                  <p className="text-[13px]" style={{ color: '#e57373' }}>
        ...
        {/* ── Info card ── */}
        <motion.div
          className="relative flex flex-row items-center justify-between rounded-[20px] p-4 md:py-5 md:px-10 mt-2 overflow-hidden"
          style={{
            background: 'rgba(255, 255, 255, 0.04)',
            backdropFilter: 'blur(32px) saturate(180%)',
            WebkitBackdropFilter: 'blur(32px) saturate(180%)',
            border: '1px solid rgba(255, 255, 255, 0.08)',
            boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.12), inset 0 -1px 0 rgba(0,0,0,0.2), 0 8px 32px rgba(0,0,0,0.3)',
          }}
          {...fadeUp(0.15)}
        >
          {/* Aurora background */}
          ...
          <div className="relative flex flex-col gap-1">
            ...
            <p className="text-md" style={{ color: 'var(--color-brand)' }}>Design Engineer</p>
          </div>
        ...
        {/* ── Copyright ── */}
        <motion.p
          className="text-center text-md pt-10"
