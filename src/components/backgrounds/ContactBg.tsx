...
export default function ContactBg({
  ...
  const propsRef = useRef<ContactBgState>({ colorStops, amplitude, blend, speed })
...
function setupContactBg(container: HTMLElement, propsRef: RefObject<ContactBgState>): WebGLBackgroundContext {
