...
interface TestimonialsVeilProps {
  hueShift?: number
...
interface TestimonialsVeilState {
  hueShift: number
  noiseIntensity: number
  scanlineIntensity: number
  speed: number
...
export default function TestimonialsVeil({
  ...
  warpAmount = 0,
  resolutionScale = 1,
}: TestimonialsVeilProps) {
  const containerRef = useRef<HTMLDivElement>(null)
  const propsRef = useRef<TestimonialsVeilState>({ hueShift, noiseIntensity, scanlineIntensity, speed, scanlineFrequency, warpAmount, resolutionScale })
