...
const ContentSecurityPolicy = [
  ...
  `font-src 'self' https://api.fontshare.com https://cdn.fontshare.com${isDev ? ' https://vercel.live' : ''}`,
  `frame-src https://cal.com https://app.cal.com https://www.figma.com https://embed.figma.com${isDev ? ' https://vercel.live' : ''}`,
